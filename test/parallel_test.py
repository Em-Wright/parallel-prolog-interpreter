...
# TEST 1
args = ["../bin/parallel.exe", '-file', '../prolog_programs/test_nqueensgen.pl', '-num-workers', '6']
...
# TEST 2
args = ["../bin/parallel.exe", '-file', '../prolog_programs/test_perm.pl', '-num-workers', '6']
ans = """Welcome to the Prolog Interpreter
...
# TEST 3
args = ["../bin/parallel.exe", '-file', '../prolog_programs/test_fib.pl', '-num-workers', '6']
ans = """Welcome to the Prolog Interpreter
...
args = ["../bin/parallel.exe", '-file', '../prolog_programs/test_cut.pl', '-num-workers', '6']
ans = """Welcome to the Prolog Interpreter
